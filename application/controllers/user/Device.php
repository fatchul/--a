	...
	function index(){
		...
		$id_user=$this->user->specific_column('id_user','email',$sesi);
			...
			if($user_isExist){
				...
				$data['body']="front/user/my_device";
...
// =================================================================================
	...
	function reg_device()
	{
		...
		$this->load->view("Docs/api-devices-public/index.php",$data);
	}
	...
	function docs(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['body']="Docs/api-devices-public/index";
			$this->load->view("template/front/core",$data);
	...
	function dev_man(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/dev_man";
			$this->load->view("template/front/core",$data);
	...
	function new_reg(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/new_reg";
			$this->load->view("template/front/core",$data);
	...
	function misc(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/misc";
			$this->load->view("template/front/core",$data);
	...
	function gpio(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/gpio";
			$this->load->view("template/front/core",$data);
	...
	function adc(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/adc";
			$this->load->view("template/front/core",$data);
	...
	function spi(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/spi";
			$this->load->view("template/front/core",$data);
	...
	function uart(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/uart";
			$this->load->view("template/front/core",$data);
	...
	function i2c(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/i2c";
			$this->load->view("template/front/core",$data);
	...
	function pwm(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/pwm";
			$this->load->view("template/front/core",$data);
	...
	function dht(){
		...
		*/
		...
		if($user_isExist){
			...
			$data['seo']="Arkana API Documentation";
			$data['body']="Docs/api-devices-public/dht";
			$this->load->view("template/front/core",$data);

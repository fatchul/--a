...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h3 style="margin-bottom: 0px">ALL</h3>
                            <h5 class="text-muted">ALL ARKANA API AVAILABLE</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">

<pre>
<b>base API url :</b>
http://api.arkademy.com:3000/
</pre>
                            
                            <div class="well">
                                <div id="swagui-all" class="swagger-ui-wrap"></div>
                            </div>
                            <p></p>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO',domid:'swagui-all'}));
        swaggerUi.load();  
        addAuthorization();

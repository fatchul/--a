                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="<?= base_url('u/device/misc')?>">Miscellanous</a></li>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO/part/misc',domid:'swagui-misc'}));
        swaggerUi.load();  
        addAuthorization();

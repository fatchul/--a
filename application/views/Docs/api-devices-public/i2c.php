                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li><a href="<?= base_url('u/device/uart')?>">UART</a></li>
                        <li class="active"><a href="<?= base_url('u/device/i2c')?>">I2C</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Creating Communication Protocol by  using SDA and SCL</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">
                            <div class="well">
                                <div id="swagui-i2c" class="swagger-ui-wrap"></div>
                            </div>
                            <p>merupakan multi-master, multi-slave, single-ended, serial computer bus yang dirancang oleh Philips Semiconductor (sekarang NXP Semiconductors). Biasanya digunakan untuk memasang periperal IC ke processor dan microcontroller yang berkecepatan rendah dan jarak dekat, atau komunikasi intra-board</p>
                            <h5>I2C/CONTROL</h5>
                            <p>Mengirimkan data dalam bentuk base64, dengan ukuran data maksimal 264 bytes</p>
                            
                            <h5>I2C/DATA</h5>
                            <p>Mengambil data dalam bentuk base64</p>
    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        function registerAuthListener(params){
          ...
          registerAuthListener({swagobj:window.swagui_i2c});
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO/part/adc',domid:'swagui-adc'}));
        swaggerUi.load();  
        addAuthorization();

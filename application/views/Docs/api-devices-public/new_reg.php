                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="<?= base_url('u/device/new_reg')?>">New Device</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Register a New Device into The Platform</h5>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/device/part/register',domid:'swagui-register-device'}));
        swaggerUi.load();  
        addAuthorization();

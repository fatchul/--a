                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li><a href="<?= base_url('u/device/api/docs')?>">All</a></li>
                        <li><a href="<?= base_url('u/device/dev_man')?>">Device Management</a></li>
                        <li><a href="<?= base_url('u/device/misc')?>">Miscellanous</a></li>
                        <li><a href="<?= base_url('u/device/gpio')?>">GPIO</a></li>
                        <li><a href="<?= base_url('u/device/adc')?>">ADC</a></li>
                        <li><a href="<?= base_url('u/device/spi')?>">SPI</a></li>
                        <li class="active"><a href="<?= base_url('u/device/uart')?>">UART</a></li>
                        <li><a href="<?= base_url('u/device/i2c')?>">I2C</a></li>
                        <li><a href="<?= base_url('u/device/pwm')?>">PWM</a></li>
                        <li><a href="<?= base_url('u/device/dht')?>">DHT</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Creating Communication protocol by using TX and RX</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">
                            <div class="well">
                                <div id="swagui-uart" class="swagger-ui-wrap"></div>
                            </div>
                            <p>Universal asynchronous receiver/transmitter (UART), sebuah device hardware komputer komunikasi asynchronous dengan kemampuan untuk konfigurasi kecepatan transmisi data dan format data. Level sinyal elektronik dan metode dapat ditangani oleh driver circuit eksternal kepada UART.</p>
                            <h5>UART/CONTROL</h5>
                            <p>ESP8266 pada PIN 3(RX) dan PIN 1(TX) akan mengirimkan data dalam format base64
                            <br>
                            contoh : kecepatan transfer 115200, dan data yang dikirim dalam base 64 adalah YXJrYW5hIGJlc3QgcGxhdGZvcm0= yang berarti dalam UTF-8 arkana best platform
<pre>
<b>request body :</b>
{
  "controls":{
    "mode":"115200",
    "data":"YXJrYW5hIGJlc3QgcGxhdGZvcm0="
  }
}
</pre>
                            </p>
                            <h5>UART/INT</h3>
                            <p>Membuat ESP8266 menerima notifikasi dari UART, waktu minimal dalam 250 mili second
                            <br>
                            contoh : kecepatan transfer 115200, dan meminta device untuk mengirimkan notifikasi setiap 1250 miliseconds
<pre>
<b>request body :</b>
{
  "controls":{
    ...
    "timeout":"1250"
                            ...
                            <h5>UART/DATA</h3>
                            <p>Menerima data dalam bentuk base64</p>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO/part/uart',domid:'swagui-uart'}));
        swaggerUi.load();  
        addAuthorization();

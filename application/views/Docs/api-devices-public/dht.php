                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="<?= base_url('u/device/dht')?>">DHT</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Getting data of humidity and temperature</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">
                            <div class="well">
                                <div id="swagui-dht" class="swagger-ui-wrap"></div>
                            </div>
                            <p>DHT berfungsi untuk mengambil data temperatur suhu dan kelembaban udara. Pada mikrontroler dapat dikoneksikan pada PIN apa saja</p>
                            <h5>DHT11/DATA</h5>
                            <p>Mengambil nilai data temperatur dan kelembaban udara dengan sensor DHT11</p>
                            <h5>DHT22/DATA</h5>
                            <p>Mengambil nilai data temperatur dan kelembaban udara dengan sensor DHT22</p>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO/part/dht',domid:'swagui-dht'}));
        swaggerUi.load();  
        addAuthorization();

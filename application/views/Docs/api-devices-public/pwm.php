                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="<?= base_url('u/device/pwm')?>">PWM</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Controlling Servo or Generating Square Wave</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">
                            <div class="well">
                                <div id="swagui-pwm" class="swagger-ui-wrap"></div>
                            </div>
                            <p>PWM (Pulse Width Modulation) digunakan untuk mengendalikan perputaran servo</p>
                            <h5>PWM/CONTROL</h5>
                            <p>Mengendalikan Servo</p>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO/part/pwm',domid:'swagui-pwm'}));
        swaggerUi.load();  
        addAuthorization();

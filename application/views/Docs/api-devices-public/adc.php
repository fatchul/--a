                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="<?= base_url('u/device/adc')?>">ADC</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Analog Digital Converter, Knowing the value of analog</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">
                            <div class="well">
                                <div id="swagui-adc" class="swagger-ui-wrap"></div>
                            </div>
                            <p>ADC berfungsi untuk mengubah sinyal analog menjadi digital, dari 0 hingga 1. ADC pada ESP8266 hanya ada satu pada ADC0</p>
                            <h5>ADC/INT</h5>
                            <p>Meminta device untuk mengirimkan <b>notifikasi</b> yang berisikan nilai <b>pin ADC</b>
                            <br>
                            contoh : Meminta device untuk mengirimkan notifikasi yang berisi nilai dari <b>pin ADC0</b> setiap 1250 miliseconds
...
<b>request body :</b>
{
  "controls":{
    "0":"1250"
                            ...
                            <h5>ADC/DATA</h5>
                            <p>Mengetahui nilai PIN mikrokontroler, apakah dalam kondisi HIGH atau LOW.</p>

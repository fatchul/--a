                    ...
                    <div class="col-xs-3"> 
                     <!--  <ul class="nav nav-tabs tabs-left tabs-left sideways"> -->
                      <ul class="sidenav nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="<?= base_url('u/device/spi')?>">SPI</a></li>
...
============================================ -->
                    <div class="col-xs-9">
                        <div class="row">
                            ...
                            <h5 class="text-muted">Creating Communication Protocol by using MISO, MOSI, CLK, CS</h5>
                            <hr width="10%" align="left" style="border-color: #f37e00;border-width: 5px">
                            <div class="well">
                                <div id="swagui-spi" class="swagger-ui-wrap"></div>
                            </div>
                            <p> Serial peripheral Interface bus merupakan antarmuka komunikasi serial yang digunakan untuk komunikasi jarak dekat, terutama pada sistem tertanam (embed).</p>
                             <h5>SPI/DATA</h5>
                            <p>Mengambil data melalui SPI BUS</p>
                            <h5>SPI/CONTROL</h5>
                            <p>Mengirimkan data melalui SPI BUS</p>
...
======================================== -->
    ...
    <script type="text/javascript">
      ...
      $(function () {
        ...
        swaggerUi = new SwaggerUi(getConfigDevice({tag:'/IO/part/spi',domid:'swagui-spi'}));
        swaggerUi.load();  
        addAuthorization();

...
<ul class="sidebar-panel nav">
  ...
  <li><a href="<?php echo site_url('g/dashboard') ?>"><span class="icon color5"><i class="fa fa-home"></i></span>Course<span class="label label-default"><?php echo $jml ?></span></a></li>  
  ...
  <li><a href="#"><span class="icon color7"><i class="fa fa-trophy"></i></span>Master<span class='caret'></span></a>
    <ul>      
      <li><a href="<?php echo site_url('g/siswa') ?>">Data Siswa</a></li>

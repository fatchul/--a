            ...
            <table id="example" class="table table-striped table-bordered table-responsive" width="100%" cellspacing="0">
                ...
                foreach($devices as $key=>$val){
                    ...
                    echo '<tr>';
                        ...
                        echo '</td>'; 
                        echo '<td>';
                        echo '<a href="'.site_url('u/device/delete/'.$val).'">Delete</a>';
                        echo '</td>'; 
                    echo '</tr>';
                }
                ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <?php echo form_open(base_url()."u/device/save","class='form-horizontal'") ?>
...
<script type="text/javascript">
  ...
  function getTokens(){ 
            $.ajax({
                    url : "<?php echo site_url('u/device/test_connect')?>",
                    type: "POST",
                    cache: false,

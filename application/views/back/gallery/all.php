...
<a  class="btn btn-info" role="button" href="<?php echo base_url('admin/gallery/tambah/') ?>">TAMBAH</a>
...
<script type="text/javascript">
  ...
  function d(id){
    if(confirm('Are you sure delete this data?')){
      $.ajax({
        url : "<?php echo site_url('admin/gallery/delete')?>/"+id,
        type: "GET",
        dataType: "JSON",
  ...
  $(document).ready(function() {
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin/gallery/list_of')?>",
            "type": "GET"
        },
